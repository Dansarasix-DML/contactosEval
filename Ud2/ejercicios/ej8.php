<?php
    ...
    */
    ...
    $link="https://github.com/Dansarasix-DML/DWES/blob/main/Ud2/ejercicios/ej8.php";
    echo "<h1>Ejercicio 8</h1>
    <p>A veces es necesario conocer exactamente el contenido de una variable. Piensa<br/>
    como puedes hacer esto y escribe un script con la siguiente salida:</p>
    <p>string(5) “Harry”<br/>
    Harry<br/>
    int(28)<br/>
    NULL
...
<head>
    ...
    <title>Unidad 2 - Ejercicio 8</title>
</head>
<body>
