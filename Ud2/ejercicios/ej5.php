<?php
    ...
    */
    ...
    $link="https://github.com/Dansarasix-DML/DWES/blob/main/Ud2/ejercicios/ej5.php";
    echo "<h1>Ejercicio 5</h1>
    <p>Script que escriba el resultado de la suma de dos números almacenados en dos
    variables.</p>";
    //Suma de números
