<?php
    ...
    */
    ...
    <p>¿Cuál es la salida del siguiente script?</p>
    <p>Prueba el script y modifícalo para las palabras DAW y DWES apararezcan en negrita.</p>
    <p>Investiga uso de print y printf para salida de texto.</p>";
    $link="https://github.com/Dansarasix-DML/DWES/blob/main/Ud2/ejercicios/ej4.php";
    $ciclo="DAW";
    $modulo="DWES";
    print "<p>";
