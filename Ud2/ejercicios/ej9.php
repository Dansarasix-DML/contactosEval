<?php
    ...
    */
    ...
    $link="https://github.com/Dansarasix-DML/DWES/blob/main/Ud2/ejercicios/ej9.php";
    echo "<h1>Ejercicio 9</h1>
    <p>Escribir un script que utilizando variables permita obtener el siguiente resultado:</p>
    <p>Valor es string.<br/>
    Valor es double.<br/>
    Valor es boolean.<br/>
    Valor es integer.<br/>
    Valor is NULL.
...
<head>
    ...
    <title>Unidad 2 - Ejercicio 9</title>
</head>
<body>
